    ...
    // Podpięcie statycznych osi VF w przypisanych ramkach tekstowych
    // Warto zmienić na listę i zapętlić
    // Wczytanie zmiennych
    const form_1 = document.querySelector('#form-1');
    // #1
    // const f_size_1 = document.getElementById('inp-f-size-1');
    ...
    // const tx_1 = document.getElementById('p-t1');
    
    // Wczytanie zapisu LocalStorage
    // #1
    // f_size_1.value = localStorage.getItem('f_size_1');
    ...
    form_1.addEventListener('submit', (event) => {
        ...
        // localStorage.setItem('p-t1', tx_1.textContent);
    ...
    // const tx_2 = document.getElementById('p-t2');
    ...
    // hw_2.value = localStorage.getItem('hard-wrap-input-2');
    // tx_2.textContent = localStorage.getItem('p-t2');
    // Uycie zapisu w tekście
    ...
    form_2.addEventListener('submit', (event) => {
        ...
        // localStorage.setItem('p-t2', tx_2.textContent);
    ...
    // const tx_3 = document.getElementById('p-t3');
    // Wczytanie zapisu LocalStorage
    // #1
    ...
    // tx_3.textContent = localStorage.getItem('p-t3');
    // Uycie zapisu w tekście
    ...
    form_3.addEventListener('submit', (event) => {
        ...
        // localStorage.setItem('p-t3', tx_3.textContent);
    ...
    // const tx_4 = document.getElementById('p-t4');
    // Wczytanie zapisu LocalStorage
    // #1
    ...
    // tx_4.textContent = localStorage.getItem('p-t4');
    // Uycie zapisu w tekście
    ...
    form_4.addEventListener('submit', (event) => {
        ...
        // localStorage.setItem('p-t4', tx_4.textContent);
    ...
    // const tx_5 = document.getElementById('p-t5');
    // Wczytanie zapisu LocalStorage
    // #1
    ...
    // tx_5.textContent = localStorage.getItem('p-t5');
    // Uycie zapisu w tekście
    ...
    form_5.addEventListener('submit', (event) => {
        ...
        // localStorage.setItem('p-t5', tx_5.textContent);
    ...
    // const tx_6 = document.getElementById('p-t6');
    // Wczytanie zapisu LocalStorage
    // #1
    ...
    // tx_6.textContent = localStorage.getItem('p-t6');
    // Uycie zapisu w tekście
    ...
    form_6.addEventListener('submit', (event) => {
        ...
        // localStorage.setItem('p-t6', tx_6.textContent);
