// ALL
// import Storage
if(localStorage.getItem("HW_all") == null) {
    const fHW_all = document.querySelector("#hardWrapInputAll");
    fHW_all.value = "___";
    console.log("empty HW");
}
else{
    const fHW_all = document.querySelector("#hardWrapInputAll");
    fHW_all.value = localStorage.getItem("HW_all");
    console.log("HW value");
}
// HardWrap Function
function editHW_all() {
        var n = document.querySelector("#hardWrapInputAll").value
        // localStorage.setItem("HW_all", n);//
        if (n > 0) {
            for (j = 0; j < columns; j++) {
                let str = document.querySelector("#p-t6").textContent;
                str = wordWrap(str, document.querySelector("#hardWrapInputAll").value);
                ...
                // document.querySelectorAll("#p-t6").innerHTML = str;
                localStorage.setItem("txt", str)
                window.location.reload();
            }
        }
    }
    editHW_all() // calling the HardWrap function
